    ...
    async generateAndRefineChunk(params) {
        ...
        try {
            ...
            if (detectionResults.needsRefinement && enableRefinement) {
                console.log(`Chunk ${chunkIndex} needs refinement (Premium tier): ${detectionResults.reason}`);
            } else if (detectionResults.needsRefinement && !enableRefinement) {
                console.log(`Chunk ${chunkIndex} needs refinement but skipping (Standard tier): ${detectionResults.reason}`);
            }
